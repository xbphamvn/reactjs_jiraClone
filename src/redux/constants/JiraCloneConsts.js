...
export const ACT_PUSH_ONSEARCH_RESULT_ARR_TO_REDUX = 'ACT_PUSH_ONSEARCH_RESULT_ARR_TO_REDUX';
...
export const SGA_CLICKED_YES_DELETE_BTN = 'SGA_CLICKED_YES_DELETE_BTN';
export const SGA_ADD_MEMBER_TO_PROJECT_ON_SEARCH = 'SGA_ADD_MEMBER_TO_PROJECT_ON_SEARCH';
export const SGA_ASSIGN_MEMBER_TO_PROJECT = 'SGA_ASSIGN_MEMBER_TO_PROJECT';
export const SGA_REMOVE_MEMBER_OF_PROJECT = 'SGA_REMOVE_MEMBER_OF_PROJECT';

//PROJECT DASHBOARD
//1. Project detail
export const SGA_DASHBOARD_GET_PROJECT_DETAIL = 'SGA_DASHBOARD_GET_PROJECT_DETAIL';
