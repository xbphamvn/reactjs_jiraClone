...
export const actClickEditBtnProjectItem = (Component) => ({
    ...
    Component,
    title: ACT_EDIT_BTN_MANAGEMENT_ACTION_TITLE
})
...
//MENU SIDEBAR CREATE NEW TASK
//1. Click create new task button
export const actClickCreateNewTaskBtn = (Component) => ({
    type: ACT_MENUBAR_CREATE_NEW_TASK_BTN,
    Component,
    title: ACT_MENUBAR_CREATE_NEW_TASK_TITLE
})
